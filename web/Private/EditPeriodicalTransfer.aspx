<%@ Page Language="C#" AutoEventWireup="False" CodeBehind="EditPeriodicalTransfer.aspx.cs" Inherits="AIM.PBC.Web.Private.Pages.EditPeriodicalTransfer" %>
...
<html>
<uc:Head ID="ctrlHead" runat="server" PageTitle='<%# OperationText + " Periodical Transfer" %>'/>
<body>
	...
	<cc:Panel runat="server" Title='<%# OperationText + " Periodical Transfer"%>' Width="740" CellPadding="0" CellSpacing="0">
